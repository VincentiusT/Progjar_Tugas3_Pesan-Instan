...
def read_msg(clients, friends, sock_cli, addr_cli, src_username):
    while True:
        ...
        if dest == "bcast":
            ...
            send_broadcast(clients, friends, src_username, _msg, addr_cli)
        elif dest == "sendfile":
            ...
            dest_sock_cli = get_sock(clients, friends, src_username, dest_username)
...
def send_broadcast(clients, friends, src_username, data, sender_addr_cli):
...
def get_sock(clients, friends, src_username, dest_username):
